...
public class AttrGroupController {
    ...
    public R getAttrGroupWithAttrs(@PathVariable("catelogId")Long catelogId){
        ...
        List<AttrGroupWithAttrsVo> collect = vos.stream().filter(i -> i.getAttrs() != null).collect(Collectors.toList());
    ...
    public R noattrRelation(@PathVariable("attrgroupId") Long attrgroupId,
        ...
        PageUtils page =  attrService.getNoRealtionAttr(params,attrgroupId);
